...
[inline]
pub fn log_post(p_log &C.ma_log, level u32, p_message &u8) Result {
...
[inline]
pub fn log_postv(p_log &C.ma_log, level u32, p_format &u8, args C.va_list) Result {
...
[inline]
pub fn (mut p_device Device) get_name(typ DeviceType, p_name &u8, name_cap usize, p_length_not_including_null_terminator &usize) Result {
...
[inline]
pub fn vfs_open(p_v_f_s &C.ma_vfs, p_file_path &u8, open_mode u32, p_file &C.ma_vfs_file) Result {
...
[inline]
pub fn vfs_open_and_read_file(p_v_f_s &C.ma_vfs, p_file_path &u8, pp_data &voidptr, p_size &usize, p_allocation_callbacks &C.ma_allocation_callbacks) Result {
...
[inline]
pub fn decoder_init_vfs(p_v_f_s &C.ma_vfs, p_file_path &u8, p_config &DecoderConfig, p_decoder &Decoder) Result {
...
[inline]
pub fn decoder_init_file(p_file_path &u8, p_config &DecoderConfig, p_decoder &Decoder) Result {
...
[inline]
pub fn decode_from_vfs(p_v_f_s &C.ma_vfs, p_file_path &u8, p_config &DecoderConfig, p_frame_count_out &u64, pp_p_c_m_frames_out &voidptr) Result {
...
[inline]
pub fn decode_file(p_file_path &u8, p_config &DecoderConfig, p_frame_count_out &u64, pp_p_c_m_frames_out &voidptr) Result {
...
[inline]
pub fn encoder_init_vfs(p_v_f_s &C.ma_vfs, p_file_path &u8, p_config &C.ma_encoder_config, p_encoder &C.ma_encoder) Result {
...
[inline]
pub fn encoder_init_file(p_file_path &u8, p_config &C.ma_encoder_config, p_encoder &C.ma_encoder) Result {
...
[inline]
pub fn resource_manager_register_file(p_resource_manager &C.ma_resource_manager, p_file_path &u8, flags u32) Result {
...
[inline]
pub fn resource_manager_register_decoded_data(p_resource_manager &C.ma_resource_manager, p_name &u8, p_data voidptr, frame_count u64, format Format, channels u32, sample_rate u32) Result {
...
[inline]
pub fn resource_manager_register_encoded_data(p_resource_manager &C.ma_resource_manager, p_name &u8, p_data voidptr, size_in_bytes usize) Result {
...
[inline]
pub fn resource_manager_unregister_file(p_resource_manager &C.ma_resource_manager, p_file_path &u8) Result {
...
[inline]
pub fn resource_manager_unregister_data(p_resource_manager &C.ma_resource_manager, p_name &u8) Result {
...
[inline]
pub fn resource_manager_data_buffer_init(p_resource_manager &C.ma_resource_manager, p_file_path &u8, flags u32, p_notifications &C.ma_resource_manager_pipeline_notifications, p_data_buffer &C.ma_resource_manager_data_buffer) Result {
...
[inline]
pub fn resource_manager_data_stream_init(p_resource_manager &C.ma_resource_manager, p_file_path &u8, flags u32, p_notifications &C.ma_resource_manager_pipeline_notifications, p_data_stream &C.ma_resource_manager_data_stream) Result {
...
[inline]
pub fn resource_manager_data_source_init(p_resource_manager &C.ma_resource_manager, p_name &u8, flags u32, p_notifications &C.ma_resource_manager_pipeline_notifications, p_data_source &C.ma_resource_manager_data_source) Result {
...
[inline]
pub fn engine_play_sound_ex(p_engine &C.ma_engine, p_file_path &u8, p_node &C.ma_node, node_input_bus_index u32) Result {
...
[inline]
pub fn engine_play_sound(p_engine &C.ma_engine, p_file_path &u8, p_group &C.ma_sound_group) Result {
...
[inline]
pub fn sound_init_from_file(p_engine &C.ma_engine, p_file_path &u8, flags u32, p_group &C.ma_sound_group, p_done_fence &C.ma_fence, p_sound &C.ma_sound) Result {
